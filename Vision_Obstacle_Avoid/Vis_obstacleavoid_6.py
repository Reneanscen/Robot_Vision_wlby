...
class RealSenseSubscriber(Node):
    ...
    def get_rgb_image(self, msg):
        ...
        rgb_transform_time = time.time()
        print("RGB transsform time:", rgb_transform_time - rgb_recv_time)
    ...
    def get_depth_image(self, msg):
        ...
        depth_recv_time = time.time()
        print("Receive depth cost time:", depth_recv_time - msg.header.stamp.sec - msg.header.stamp.nanosec / 1e9)
        ...
        depth_transform_time = time.time()
        print("Depth transsform time:", depth_transform_time - depth_recv_time)
...
model = YOLO(r'/home/zme/slam_group/ground_obstacle/obstacle_s_1080.pt')
...
try:
    ...
    while rclpy.ok():
        dajiba_start_time = time.time()
        rclpy.spin_once(node, timeout_sec=0.5)
        dajiba_end_time = time.time()
        print("dajiba time:", dajiba_end_time - dajiba_start_time)
