#ifndef CHARGING_INDENTIFI_LINEAR_POSE_FILTER_H
#define CHARGING_INDENTIFI_LINEAR_POSE_FILTER_H
...
public:
  ...
  */
  void setFilterState(const geometry_msgs::msg::Pose& input_pose, const geometry_msgs::msg::Pose& output_pose);
  ...
  */
  void setFilterState(const std::vector<geometry_msgs::msg::Pose>& input_poses,
...
private:
  ...
  std::deque<geometry_msgs::msg::Pose> out_;   /// Vector of previous output poses.
...
#endif  // CHARGING_INDENTIFI_LINEAR_POSE_FILTER_H
