...
from tasks.transparent.corelibs.models.decode import object_pose_decode, _nms, _topk, _transpose_and_gather_feat
from tasks.transparent.corelibs.utils.post_process import object_pose_post_process
                        ...
                        if self.opt.show_axes == True:
                            if self.opt.tracking_task == True:
                                if 'kps_3d_cam_kf' in bbox:
                                    debugger.add_axes(bbox['kps_3d_cam_kf'], self.opt.cam_intrinsic,
                                                      img_id='out_img_pred')
                            else:
